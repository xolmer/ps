...
Route::group( array( 'prefix' => 'users', 'before' => 'auth' ), function () {
    ...
    Route::post('changeavatar',array('as' => 'user.updateAvatar','uses' => 'UsersController@updateAvatar'));
    Route::post('removeavatar',array('as' => 'user.removeAvatar', 'uses' => 'UsersController@removeAvatar'));
