...
module.exports = function () {
    $(document).ready(function () {
        ...
        var Sender = function (id) {
            ...
            this.fathers_name = ko.observable();
            this.national_id = ko.observable();
            this.passport_number = ko.observable();
            this.email_address = ko.observable();
            this.mobile_number = ko.observable('');
            this.phone_number = ko.observable('');
            ...
            this.label = ko.computed(function () {
                ...
                return this.country() + (fullname.trim() ? ' -  ' + fullname : '');
            }, this);
        }
        ...
        var AppViewModel = function () {
            ...
            self.addNewSender = function(){
                self.senders.push(new Sender(self.makeID()));
            }

            self.removeSender = function(sender){
            ...
            self.senders = ko.observableArray([]);
