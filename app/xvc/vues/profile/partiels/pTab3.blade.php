...
<div class="form-group">
    <div class="col-sm-5">
         ...
         <a class="btn btn-red farsi" href="#removeavatar" onclick='$.post("{{URL::route('user.removeAvatar')}}").done(function(){location.reload();});'> {{Lang::get('ui.buttons.removeCurrentAvatar')}}</a>
         @endif
    </div>
</div>
